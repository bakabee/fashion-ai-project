    ...
    <div ref={containerRef} className="min-h-screen bg-luxury-bg pt-32 pb-16">
      <div className="section-padding max-w-5xl mx-auto">
        ...
        <div className="viewer-content">
          {/* Main Viewer */}
          <div className="bg-white border border-black/5 rounded-3xl shadow-sm overflow-hidden mb-8">
            <div className="aspect-video w-full bg-gradient-to-br from-dark-50 to-dark-100 flex items-center justify-center relative">
              {/* 3D Preview Placeholder - Ready for Three.js integration */}
              <div className="text-center">
                <div className="text-9xl mb-6 animate-bounce">🧍</div>
                <h2 className="text-4xl font-bold text-dark-800 mb-2">3D Mannequin Preview</h2>
                <p className="text-dark-500 text-lg">
          ...
          >
            <div className="bg-white border border-black/5 shadow-sm p-6 rounded-2xl">
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-12">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex-1 py-4 rounded-xl bg-black text-white font-bold transition-all hover:bg-dark-800"
            >
              Download Model
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex-1 py-4 rounded-xl bg-white border border-black/10 text-dark-700 font-bold transition-all hover:bg-dark-50 hover:border-black/20"
            >
              Share Design
            </motion.button>
          </div>
